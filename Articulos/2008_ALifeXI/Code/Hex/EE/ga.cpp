...
void GA::SendJointsMiddleLegs(ofstream *outFile) {

	(*outFile) << "\n( MainBody_LeftMiddleUpperLeg\n";
	(*outFile) << "-connect MainBody LeftMiddleUpperLeg\n";
	(*outFile) << "-jointPosition "	<< -BODY_WIDTH/2.0 -LEG_RADIUS<<" "
				 	<< TAR_OBJ_HEIGHT/2.0 << " "
					<< -1.5*TAR_OBJ_WIDTH - (BODY_LENGTH/2.0) -(TAR_OBJ_HEIGHT/2) <<" \n";
	(*outFile) << "-jointType Hinge\n";
	(*outFile) << "-jointNormal 1 0 0\n";
	(*outFile) << "-jointLimits -"<<LEG_EXTENSION_MAX<<" "<<LEG_EXTENSION_MAX<<"\n";
	(*outFile) << "-addMotor\n";
	...
	(*outFile) << "\n( MainBody_RightMiddleUpperLeg\n";
	(*outFile) << "-connect MainBody RightMiddleUpperLeg \n";
	(*outFile) << "-jointPosition "	<< BODY_WIDTH/2.0 +LEG_RADIUS<<" "
				 	<< TAR_OBJ_HEIGHT/2.0 << " "
					<< -1.5*TAR_OBJ_WIDTH - (BODY_LENGTH/2.0) -(TAR_OBJ_HEIGHT/2) <<" \n";
	(*outFile) << "-jointType Hinge\n";
	...
	(*outFile) << "\n( LeftMiddleUpperLeg_LeftMiddleLeg\n";
	(*outFile) << "-connect LeftMiddleUpperLeg LeftMiddleLeg\n";
	(*outFile) << "-jointPosition "	<< -BODY_WIDTH/2.0 -LEG_RADIUS <<" "
				 	<< TAR_OBJ_HEIGHT/2.0 << " "
	...
	(*outFile) << "\n( RightMiddleUpperLeg_RightMiddleLeg\n";
	(*outFile) << "-connect RightMiddleUpperLeg RightMiddleLeg\n";
	(*outFile) << "-jointPosition "	<< BODY_WIDTH/2.0 +LEG_RADIUS <<" "
				 	<< TAR_OBJ_HEIGHT/2.0 << " "
					<< -1.5*TAR_OBJ_WIDTH - (BODY_LENGTH/2.0)<<" \n";
	(*outFile) << "-jointType Hinge\n";
...
void GA::SendUpperLegs(ofstream *outFile) {
	...
	(*outFile) << "-position "	<< -BODY_WIDTH/2.0 -LEG_RADIUS<<" "
				 	<< TAR_OBJ_HEIGHT/2.0 << " "
					<< -1.5*TAR_OBJ_WIDTH - (BODY_LENGTH/2.0)  -(TAR_OBJ_HEIGHT/4.0)<<" \n";
	(*outFile) << "-shape -cylinder "	<<LEG_RADIUS<< " " << (TAR_OBJ_HEIGHT/2.0) << "\n";
	(*outFile) << "-rotation 0 0 1\n";
	(*outFile) << "-mass 1 \n";
	(*outFile) << "-colour 0 1 0 \n";
